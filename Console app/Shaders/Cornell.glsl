...
void scene_init()
{
	...
	Material blue;
	blue.diffusion_color = vec3(157, 237, 233) / (255.0 * 0.7);
	blue.specular_color = vec3(1.0);
	blue.transmissive_color = vec3(157, 237, 233) / (255.0 * 0.7);
	...
	spheres[0].material = pink;
	spheres[0].position = vec3(0.0, 0.0, 0.2);
	spheres[0].radius = 0.2;

	spheres[1].material = opaque;
	spheres[1].position = vec3(2.0, 3.0, 1.0);
	spheres[1].radius = 1.0;
	
	spheres[2].material = metallic;
	spheres[2].position = vec3(-3.0, 3.0, 0.5);
	spheres[2].radius = 0.5;

	boxes[0].material = gray;
	...
	boxes[3].position = vec3(0.0, -5.0, 11.0);
	boxes[3].halfSize = vec3(5.0, 1.0, 1.5);
	boxes[3].rotation = rot(0.785, 0, 0);
	
	boxes[4].material = green;
	boxes[4].position = vec3(6.0, 0.0, 5.0);
	boxes[4].halfSize = vec3(1.0, 5.0, 5.0);
	boxes[4].rotation = rot(0, 0, 0);
	
	boxes[5].material = red;
	...
	boxes[7].material = blue;
	boxes[7].position = vec3(-2.41, 1.0, 1.416);
	boxes[7].halfSize = vec3(1.5, 0.75, 0.05);
	boxes[7].rotation = rot(0, -1.2, 0.0);
	
	cyls[0].material = yellow;
	cyls[0].a = vec3(-4.0, 1.0, 0.0);
	cyls[0].b = vec3(-4.0, 1.0, 3.2);
	cyls[0].radius = 1.0;
}
