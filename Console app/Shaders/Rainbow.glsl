...
vec3 get_sky(vec3 rd)
{
	...
	vec3 col = texture2D(iGradient, uv).rgb * 0.1;
...
void scene_init()
{
	...
	*/
	...
	boxes[0].position = vec3(11.0, -11.0, 0.0);
	boxes[0].halfSize = vec3(1, 10, 10);
	boxes[0].rotation = rot(0, 0, 0);
	
	boxes[1].material = white;
	boxes[1].position = vec3(11.0, 11.0, 0.0);
	boxes[1].halfSize = vec3(1, 10, 10);
	boxes[1].rotation = rot(0, 0, 0);
	
	boxes[2].material = white;
	boxes[2].position = vec3(11.0, 0.0, -11.0);
	boxes[2].halfSize = vec3(1, 10, 10);
	boxes[2].rotation = rot(0, 0, 0);
	
	boxes[3].material = white;
	boxes[3].position = vec3(11.0, 0.0, 11.0);
	boxes[3].halfSize = vec3(1, 10, 10);
	boxes[3].rotation = rot(0, 0, 0);
}
